...
awful.screen.connect_for_each_screen(function(s)
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({screen = s, visible = false, ontop = true, type = "dock", position = "bottom"})
    ...
    -- Create the top bar
    s.mytopwibox = awful.wibar({screen = s, visible = false, ontop = false, type = "dock", position = "top", height = dpi(5)})
    -- Bar placement
    ...
    --s.traybox = wibox({visible = false, ontop = true, type = "dock"})
    --s.traybox.width = dpi(120)
    --s.traybox.height = beautiful.wibar_height
    --awful.placement.bottom_right(s.traybox, {honor_workarea = true, margins = beautiful.screen_margin * 2})
