...
time.font = "Product Sans 46"
time.align = "center"
time.valign = "center"
local function update_time() 
  time.markup = time.text:sub(1,2) .. "<span foreground='" .. beautiful.xcolor3 .."'> " .. time.text:sub(3,4) .. "</span>"
end
update_time()
time:connect_signal("widget::redraw_needed", update_time)
